node('build-scaleway-x64-ubuntu-16-04-2') {
  try {
    stage('Preparation') {
      ...
      checkout changelog: false, scm: [$class: 'MercurialSCM', credentialsId: '', installation: '(Default)', revision: '7.1.0-gac', revisionType: 'TAG', source: 'https://hg.openjdk.java.net/jmc/jmc7']
